...
*   **Definice entit:** Navrhni/dopln vlastnosti, atributy a datove typy pro objekty: *Predmety, Tridy, Skupiny, Zaci, Materialy, Ukoly, Testy* (a pripadne dalsi spojovaci tabulky).
