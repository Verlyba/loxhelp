...
const MOODLE_DIR = resolve(
  process.cwd(),
  "moodle_content/Course_activities_Loxone_praxe_2EB_2526__Stedn_prmyslov_kola_na_Proseku",
);
...
async function main() {
  ...
  const l1_pair1 = await db.pair.create({
    data: {
      ...
      name: "Dvojice 1",
      members: {
        create: [{ userId: anna.id }, { userId: petr.id }],
      },
    },
  });
  ...
  const l1_pair2 = await db.pair.create({
    data: {
      ...
      name: "Dvojice 2",
      members: {
        create: [{ userId: jana.id }, { userId: tomas.id }],
      },
    },
  });
  ...
  const s1 = await db.studyGroup.create({
    data: {
      ...
      name: "S1",
      members: {
        create: [{ userId: marek.id }, { userId: klara.id }, { userId: honza.id }],
      },
    },
  });
      ...
      files: [
        {
          ...
          fileName: "Harmonogram_roku.pdf",
          category: "material",
          description:
            "Harmonogram výuky a podrobný týdenní rozpis učiva pro celkem 38 týdnů školního roku Loxone.",
        },
        {
          label: "Schéma výukových panelů",
          fileName: "Schma_-_Vukov_panely.pdf",
          category: "schema",
          description:
            "Zapojení prvků na Miniserveru, schéma laboratoře a rozdělení IP adres výukových panelů 1 až 5.",
        },
      ],
    },
    {
...
Pochopení těchto technologií je nezbytné pro správný návrh a programování logiky celého domu.`,
      files: [
        {
          label: "Prezentace – Moderní instalace",
          fileName: "Prezentace_-_Modern_instalace.pptx",
          category: "presentation",
          description:
            "Výklad o integraci osvětlení, stínění, topení, rekuperace, zabezpečení a FVE s ohledem na průkaz PENB.",
        },
      ],
    },
    {
...
- Vytvoření nového projektu a nahrání programu do Miniserveru.`,
      files: [
        {
          label: "Prezentace – Miniserver",
          fileName: "Prezentace_-_Miniserver.pptx",
          category: "presentation",
          description:
            "Rozhraní Miniserveru, sběrnice Link, Tree & Air, napájecí zdroje a princip zpětné kompatibility.",
        },
        {
          label: "Prezentace – Úvod do systému",
          fileName: "Prezentace_-_vod_do_systmu_Loxone.pdf",
          category: "presentation",
          description:
            "Technické parametry Miniserveru (digitální/analogové I/O, LAN, SD karta) a propojení s Loxone aplikací.",
        },
        {
          label: "Manuál – Orientace v Loxone Config",
          fileName: "Manul_-_Orientace_v_Configu.pdf",
          category: "manual",
          description:
            "Příručka pro plánování projektů, správu verzí softwaru a vyhledávání Miniserverů v místní síti.",
        },
        {
          label: "Manuál – Založení programu",
          fileName: "Manul_-_Zaloen_programu.pdf",
          category: "manual",
          description:
            "Návod krok za krokem k vytvoření projektu, připojení k Miniserveru a nastavení výchozího hesla admin.",
        },
        {
          label: "Manuál – Sběrnice LINK, TREE, AIR",
          fileName: "Manul_-_LINK_TREE_AIR.pdf",
          category: "manual",
          description:
            "Pravidla a diagnostika zapojení sběrnice LINK (max. 30 extensionů) a sběrnice Tree (max. 50 prvků na větev).",
        },
      ],
    },
    {
...
- Nastavit automatiku na základě čidel přítomnosti a intenzity venkovního světla.`,
      files: [
        {
          label: "Prezentace – Osvětlení",
          fileName: "Prezentace_-_Osvtlen.pptx",
          category: "presentation",
          description:
            "Varianty osvětlení (spínané, stmívané AC/DC, barevné RGB/CCT), světelné nálady a ovládání Touch tlačítky.",
        },
        {
          label: "Manuál – Konfigurace osvětlení",
          fileName: "Manul_-_Osvtlen.pdf",
          category: "manual",
          description:
            "Zapojení a nejdůležitější parametry funkčního bloku Ovládání osvětlení (Off, Touch T5, čidlo jasu, pohyb).",
        },
        {
          label: "Schéma zapojení v rodinném domě",
          fileName: "Schma_-_Osvtlen_v_dom.pdf",
          category: "schema",
          description:
            "Blokové schéma zapojení tlačítek Touch Tree, senzorů přítomnosti a LED světel na sběrnici Tree.",
        },
      ],
    },
    {
...
- Výhody prediktivního vytápění s ohledem na setrvačnost systému.`,
      files: [
        {
          label: "Manuál – Regulace vytápění v praxi",
          fileName: "Manul_-_Vytpn.pdf",
          category: "manual",
          description:
            "Tříúrovňový manuál pro zónovou regulaci teploty, kotle a termostatických ventilů (Intelligent Room Controller).",
        },
      ],
    },
    {
...
- Bezpečnostní prvky – větrný a mrazový alarm (ochrana před poškozením).`,
      files: [
        {
          label: "Manuál – Konfigurace stínící techniky",
          fileName: "Manul_-_Stnc_technika.pdf",
          category: "manual",
          description:
            "Návod k nastavení bloku Automatické žaluzie, časů chodu žaluzií/rolet a automatického stínění podle slunce.",
        },
      ],
    },
    {
...
Všechny podrobné požadavky, ceník a doporučenou šablonu zprávy naleznete v souborech níže.`,
      files: [
        {
          label: "Kompletní zadání projektu",
          fileName: "Zadn.pdf",
          category: "template",
          description:
            "Oficiální zadání ročníkového projektu (obsah dokumentace, zadání půdorysu, konfigurace a zprávy).",
        },
        {
          label: "Doporučená šablona projektu",
          fileName: "ablona.docx",
          category: "template",
          description:
            "Word šablona pro vypracování textové dokumentace se všemi předepsanými kapitolami.",
        },
        {
          label: "Ceník komponentů Loxone",
          fileName: "Cenk_komponent.pdf",
          category: "material",
          description:
            "Aktuální ceník prvků Loxone v CZK s katalogovými SKU čísly pro sestavení rozpočtu a kalkulaci investice.",
        },
      ],
    },
    {
...
Pro rychlé nakreslení půdorysu domu doporučujeme program ProfiCAD. Níže naleznete stručnou příručku k ovládání.`,
      files: [
        {
          label: "Metodika využití AI a LLM",
          fileName: "Metodika_pouit_LLM.pdf",
          category: "material",
          description:
            "Metodická pravidla pro bezpečné a smysluplné využití AI (LLM) jako podpůrného nástroje při psaní zprávy.",
        },
        {
          label: "Příručka pro kreslení v ProfiCADu",
          fileName: "Manul_-_ProfiCAD.pdf",
          category: "manual",
          description:
            "Krok za krokem návod pro kreslení stavebních půdorysů a nastavení výkresů v programu ProfiCAD.",
        },
      ],
    },
    {
...
- **Závěrečný test** — komplexní test pokrývající všechna témata včetně zónové regulace a pokročilé automatiky stínění.`,
    },
    {
      ...
      files: [
        {
          label: "Zadání SP – Osvětlení (PDF)",
          fileName: "SP_-_Osvtlen.pdf",
          category: "template",
          description:
            "Zadání samostatné práce na konfiguraci osvětlení (3 scény, Touch Tree, senzor přítomnosti) pro klienta Jana Nováka.",
        },
      ],
    },
  ];
...
V této sekci naleznete příručky, odkazy na dokumentaci a užitečná videa z výukových lekcí 3D CAD modelování.`,
  ...
  const contents =
    "Seed soubor: programování celého panelu v1 (placeholder pro demonstraci verzování).\n";
  ...
  const feedbackText =
    "Výborná práce s regulací IRC, logické řazení ventilů a implementace útlumových režimů.";
